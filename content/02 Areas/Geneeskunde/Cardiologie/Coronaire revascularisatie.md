...
- CT coronairen
    ...
    - onvoldoende resolutie voor inschatting ernst (coronarografie beter)
- Coronarografie
    **Anatomisch**
...
## Indicaties
- Significant hoofdstamletsel (CAVE anatomische varianten)
...
| CABG on-pump                                         | CABG off-pump                             | MIDCAB                                                                            |
| ---------------------------------------------------- | ----------------------------------------- | --------------------------------------------------------------------------------- |
| - Meest gebruikt<br>- Met extracorporeal circulation | - Zonder extracorporeal circulation       | = minimally invasive direct coronary artery bypass<br>- endoscopisch en robotisch |
| ![[Untitled 46.png\|Untitled 46.png]]                | ![[Untitled 1 10.png\|Untitled 1 10.png]] |                                                                                   |

Entmateriaal
    - Arterieel (voorkeur want betere doorgankelijkheid op lange termijn)
...
- Revalidatie (bewegen!)
- medicatie
- controle van [[Diabetes mellitus]] en nierinsufficiëntie
- Levensstijl (rookstop, gewichtsreductie)

> [!important] [[The obesity paradox in elderly obese patients undergoing coronary artery bypass surgery]]
> -> Despite being labeled as higher risk candidates preoperatively, **obese elderly patients undergoing CABG did not demonstrate an increased risk of postsurgical complications**. We conclude that the 'obesity paradox' is present in this population, and they should not be excluded from receiving the benefits of CABG
...
### Indicaties
- Eéntakslijden (niet proximaal LAD)
