...
==**Eerst uitleggen -> dan zelf demonstreren -> tenslotte vragen aan de patiënt om het zelf uit te voeren (met feedback)**==
...
- Algemeen
    ...
    **Nadelen -**
    - **coördinatie activatie x inhalatie**
...
> [!ATTENTION] Synchroniseer inademing en doseeraerosol
...
> [!important]  
> PERFECT **verticaal** houden (zodat poeder er niet uitvalt)  
...
- Novolizer
    ...
    **Techniek**
    6. Rechtop zitten
    7. Neem beschermdop van mondstuk
    8. Druk knop volledig en laat los
        1. **Hou Novolizer horizontaal**
        2. Je hoort een dubbele ‘klik’ en de kleur verandert van rood naar groen
    9. Adem rustig en volledig in
        1. Blijf Novolizer horizontaal vasthouden
    10. Neem het mondstuk in de mond
        1. Tussen tanden
        2. Omsluit goed met lippen
    11. Buig hoofd licht achterover
    12. Adem snel en diep in
        1. Je hoort een ‘klik’
    ...
    13. Hou adem 5-10 seconden in
    14. Adem rustig uit door mond
        1. NIET IN NOVOLIZER
    15. Bij meerdere dosissen:
        1. Druk knop opnieuw volledig in en herhaal volgende stappen
    16. Plaats beschermdop terug op mondstuk
    17. Spoel mond met water
        1. NIET INSLIKKEN
...
- Respimat
    ...
    **Eerste gebruik**
    ...
    12. Sluit de bovenste beschermkap
	    ...
	    **Techniek**
    13. Rechtop zitten
    14. Draai het onderste deel in 1 beweging 180° tegenwijzersin tot u een ‘klik’ hoort
    15. Verwijder beschermkap van de inhalator (naar achter klappen)
    16. Adem rustig en volledig uit
        1. NIET IN INHALATOR
    17. Neem het mondstuk in de mond
        1. TUSSEN TANDEN
        2. Omsluit met lippen
    18. Buig hoofd licht achterover
    19. Adem **langzaam** diep in
        1. Druk gelijktijdig bovenaan op de ontspanner
        2. Blijf daarna langzaam verder en volledig inademen
    20. Hou adem 5-10 seconden in
    21. Adem rustig uit langs de mond
        1. NIET IN INHALATOR
    22. Plaats beschermkap terug op nmondstuk (teruklappen)
    23. Bij meerdere dosissen:
        1. Herhaal vanaf stap 2
    24. Spoel de mond met water
        1. NIET INSLIKKEN
