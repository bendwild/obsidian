...
- Enkel-arm index
    ...
    - Normaal > 0,95 in rust
	    -   EAl > 1.3 ⇒ niet-comprimeerbare vaten (calcificaties - atherosclerose)
    - EAI < 0.9 ⇒ RR 3.3 (cardiovasculaire mortaliteit)
	    - EAI 0.5-0.9 ⇒ [[claudicatio]]
	    - EAI < 0.5 ⇒ kritische lidmaatischemie
...
> [!EXAMPLE] Rood Rechts, Ferrari op de weg (zwart), de zon (geel) boven het gras (groen)
