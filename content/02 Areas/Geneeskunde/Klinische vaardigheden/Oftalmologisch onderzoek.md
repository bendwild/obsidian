...
- Laat de patiënt goed definiëren wat men verstaat onder visusverlies
    ...
    - Gelokaliseerde vlekken in het gezichtsveld die steeds op zelfde plaats blijven bij links/rechts kijken VS grijzige vlekken die meebewegen en niet op dezelfde plaats voorkomen (glasvochttroebelingen = floaters)
...
- Zijn er bijkomend veranderingen in de kwaliteit van de visus?
    ...
    - Lichtflitsen
    - Veranderde kleurperceptie (asymmetrie in de ‘felheid’ van kleuren, vooral rood)
...
- Cover/Uncovertest
    ...
    **Bevestigen van een manifest strabisme (heterotropie)**
    ...
    2. Dek afwisselend met je hand (perfect gesloten vingers) 1 oog af 
	    -> sta temporeel binoculair zicht toe
...
- Swinging flashlight test
    ...
    3. Beschijn 1 van beide pupillen 
	    → wacht enkele seconden tot pupil stabiel evenwicht heeft gevonden vooraleer van kant te wisselen
    4. Beschijn vervolgens het andere oog en evalueer de fotomotoriek
    
    Wordt gebruikt om een **relatief afferent pupildefect** (RAPD) op te sporen
    → paradoxale mydriase tijdens beschijnen oog
    → relatief minder miose aangetast oog ivm contralateraal oog

    Dit wijst op een ernstige aantasting van de **retinale lichtperceptie en/of geleiding** van het signaal van de optische zenuw (optische neuritis, optic nerve compression, trauma, [[multipele sclerose]]...)
