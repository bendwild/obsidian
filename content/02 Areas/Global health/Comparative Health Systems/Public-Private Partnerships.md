...
1. Fiscal
	1. Private financing builds infrastructure without immediate public expenditure. Useful when capital budgets are constrained.
2. Capacity
	1. Private management may bring technical or administrative capacity the public sector lacks.
3. Efficiency
	1. Competition and private incentives may reduce costs per service delivered.

# Conditions under which PPPs work
*Evidence from systematic reviews (Barr et al., Basu et al.)*

- Contract is specific, measurable, and enforceable
- Government has regulatory capacity to monitor performance
