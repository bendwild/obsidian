...
| ------------------------ | ----------------------------- |
| Funds flow automatically | Active decisions              |
| Historical allocations   | Based on need and performance |
...
> [!ATTENTION] A well-financed system with poor purchasing can still produce bad outcomes
